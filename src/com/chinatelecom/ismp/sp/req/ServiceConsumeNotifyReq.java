 ...
 */
            ...
            /**
            *  ServiceConsumeNotifyReq bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        /**
                        * field for FeatureStr
                        */

                        
                                    protected java.lang.String localFeatureStr ;
                           ...
                           */
                           public  java.lang.String getFeatureStr(){
                            ...
                            /**
                               ...
                               * @param param FeatureStr
                               */
                               public void setFeatureStr(java.lang.String param){
                            
                                            this.localFeatureStr=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ServiceConsumeNotifyReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ServiceConsumeNotifyReq",
                           xmlWriter);
                   }
                                    ...
                                    writeStartElement(null, namespace, "featureStr", xmlWriter);
                             

                                          if (localFeatureStr==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localFeatureStr);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://req.sp.ismp.chinatelecom.com",
                                         ...
                                         elementList.add(localFeatureStr==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFeatureStr));
                                    
                                      elementList.add(new javax.xml.namespace.QName("http://req.sp.ismp.chinatelecom.com",
                                                                      "linkID"));
                                 
                                         elementList.add(localLinkID==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localLinkID));
    ...
    public static class Factory{
        ...
        */
        public static ServiceConsumeNotifyReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ServiceConsumeNotifyReq object =
                new ServiceConsumeNotifyReq();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ServiceConsumeNotifyReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ServiceConsumeNotifyReq)com.chinatelecom.ismp.sp.req.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://req.sp.ismp.chinatelecom.com","featureStr").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://req.sp.ismp.chinatelecom.com","linkID").equals(reader.getName())){
